    ...
    <ul class="layui-nav fly-nav-user">
      ...
      <li class="layui-nav-item">
        ...
        <dl class="layui-nav-child">
          <dd><a href="set.volt"><i class="layui-icon">&#xe620;</i>基本设置</a></dd>
          <dd><a href="message.volt"><i class="iconfont icon-tongzhi" style="top: 4px;"></i>我的消息</a></dd>
        ...
        <ul class="layui-form">
          ...
          <li class="layui-form-li" style="margin-top: 20px; line-height: 26px;">
            <div>
              ...
              <a class="layui-form-a" style="color:#4f99cf;" href="set.volt">更换邮箱</a>；
            </div>
            <div>
